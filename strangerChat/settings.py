...
SECRET_KEY = 'django-insecure-@j=z05*gzb508g*ckw0ggks&ansseta+jjlx*2p(zy==l-)u12'
...
ROOT_URLCONF = 'strangerChat.urls'
...
# https://do s.djangoproject.com/en/4.0/topics/i18n/
